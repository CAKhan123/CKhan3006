...
void test_power()
{
	...
	int boundary_test = power(12, 2);
	TEST_ASSERT_EQUAL(144, boundary_test);
	int overflow_test = power(3, 5);
	TEST_ASSERT_EQUAL(243, overflow_test);
}
